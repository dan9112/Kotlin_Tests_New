        ...
        if (ContextCompat.checkSelfPermission(
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(activity, permission)) {
                ...
                /*
                    ...
                    */
                Log.d("PermissionUtils", "onPermissionDenied")
                ...
                if (getApplicationLaunchedFirstTime(activity)) {
                    ...
                    //Случай 1
                    Log.d("PermissionUtils", "ApplicationLaunchedFirstTime")
                    setApplicationLaunchedFirstTime(activity) //  ** НЕ ЗАБУДЬТЕ ЭТО **
                    permissionAskListener.onPermissionRequest()
                } else {
                    //Случай 2Б
                    Log.d("PermissionUtils", "onPermissionDisabled")
                    permissionAskListener.onPermissionDisabled()
                }
            }
        } else {
            Log.d("PermissionUtils", "Permission already granted")
