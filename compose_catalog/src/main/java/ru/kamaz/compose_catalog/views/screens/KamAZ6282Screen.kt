...
fun KamAZ6282Screen(openDrawer: () -> Unit) {
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        SmallTopAppBar(
            ...
            title = { Text("${MainActivity.DrawerAppScreen.Product.KamAZ6282Screen} Title") },
            navigationIcon = {
        ...
        Surface(color = MaterialTheme.colorScheme.tertiary, modifier = Modifier.weight(1f)) {
            ...
            Column(
                ...
                content = { Text(text = "${MainActivity.DrawerAppScreen.Product.KamAZ6282Screen} content") }
            )
        }
    }
}
