...
object KamAZ4310Screen : DrawerAppScreen.Product {
    ...
    @Composable
    override fun GetView(openDrawer: () -> Unit) {
        ...
        Column(modifier = Modifier.fillMaxSize()) {
            ...
            SmallTopAppBar(
                ...
                title = { Text(text = "${this@KamAZ4310Screen} Title") },
                navigationIcon = {
            ...
            Surface(color = MaterialTheme.colorScheme.tertiary, modifier = Modifier.weight(1f)) {
                ...
                Column(
                    ...
                    content = { Text(text = "${this@KamAZ4310Screen} content") }
                )
            }
        }
    }
